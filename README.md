...
![alt text](https://github.com/landonviator/Chorus/blob/main/chorus.png "Chorus")
Here is an implementation of Juce's Chorus DSP module. The knob ranges needed a little scaling to 
make sense in terms of what users expect the knob values to be, but all in all a pretty simple effect
to implement. The range of tonal colors that this effect has is huge, from long, echo-like delays, colorful 
oscillating, and even sounds reminiscent of digital waveguides.
